...
BEGIN
    ...
    soil_ph,
    soil_texture_level,
    (soil_nitrogen_kg_ha + fertilizer_nitrogen_kg_ha) AS nitrogen_kg_ha,
    (soil_phosphorus_kg_ha + fertilizer_phosphorus_kg_ha) AS phosphorus_kg_ha,
    (soil_potassium_kg_ha + fertilizer_potassium_kg_ha) AS potassium_kg_ha,
